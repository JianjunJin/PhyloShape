...
from phyloshape.utils import PSIOError, ID_TYPE, COORD_TYPE, RGB_TYPE
from phyloshape.io.src.paths import _find_image_path
    ...
    def _get_image_path(self, fname: Union[str, Path, None]) -> Union[Path, None]:
        ...
        if fname is None:
            if self.tpath.exists():
                return self.tpath
            return _find_image_path(self.opath)
        return Path(fname)
